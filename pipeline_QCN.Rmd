...
dataPath <- "../scClustViz_files/test_mecortex171116michael/" # path to analysis output directory
...
ebRaw <- counts(read10xCounts(input_dataPath))
...
if (any(duplicated(toupper(rownames(ebRaw))))) {
  ...
  temp_r2 <- rownames(ebRaw[temp_r,])[rownames(ebRaw[temp_r,]) %in% keys(get(egDB),"SYMBOL")]
