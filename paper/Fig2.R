...
load("meCortex/e13/e13_Cortical_Only_forViz.RData")
rm(CGS,deTissue,deMarker,deNeighb)
...
lines(TPR~FPR,data=GER,type="l",col=bp[2],lwd=2)
...
pdf(file="../Reports/18_F1000Res_scClustViz/Fig2a.pdf",width=6,height=6)
par(mar=c(3,3,3,1),mgp=2:0)
...
load("liver/HumanLiver_forViz.RData")
rm(CGS,deTissue,deMarker,deNeighb)
